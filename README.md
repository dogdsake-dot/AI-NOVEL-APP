...
> **AI-NOVEL-APP Android port** — This repository tracks and vendors the upstream AI Novel Writing Assistant source, preserving upstream features while adding an Android Capacitor shell. Current synchronized upstream desktop version: **0.4.19**. Android release line: **0.2.1**. See [PORTING.md](./PORTING.md).
